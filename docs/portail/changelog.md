...
Cette page présente les principales évolutions et mises à jour de données et de fonctionnalités du Portail Biblissima au fil du temps.
...
L'icône :material-new-box: indique les nouveaux jeux de données intégrés dans le Portail.
...
- :material-new-box: Intégration des manuscrits et incunables numérisés de la **Ludwig-Maximilians-Universität München** (bibliothèque universitaire de Munich - [discover.ub.uni-muenchen.de](https://discover.ub.uni-muenchen.de/collection)) (exemple : [4° Cod.ms. 12](https://portail.biblissima.fr/fr/ark:/43093/mdata99e5ae17fa8ddc7797863c5aaeb6b4cf5b725bf1)).

- :material-new-box: Intégration des inscriptions (notices, images, références bibliographiques) du **Corpus des inscriptions de la France médiévale, 3** (Favreau Robert, Michaud Jean. _I. Poitou-Charentes. 3. Charente, Charente-Maritime, Deux-Sèvres_. Paris : CNRS Editions, 1977. 270 p.) disponible sur Persée ([www.persee.fr/doc/cifm_0000-0000_1977_cat_3_1](https://www.persee.fr/doc/cifm_0000-0000_1977_cat_3_1)) (exemple : [CIFM III, Charente, 28](https://portail.biblissima.fr/fr/ark:/43093/inscdata1b0ed802359e638503dd858bb8e956e1462fdf8f)).

- Mise à niveau de l'application web vers CubicWeb 4.

**08/10/2025**

- Mise à jour du jeu de données de **Leiden University Libraries** (manuscrits médiévaux occidentaux numérisés des bibliothèques de l'Université de Leyde, dont les 372 _Codices Vossiani Latini_ de la _Bibliotheca Vossiana_ mis à ligne en janvier 2025 par la bibliothèque universitaire de Leyde) ([digitalcollections.universiteitleiden.nl](https://digitalcollections.universiteitleiden.nl)) (exemple : [VLQ 79](https://portail.biblissima.fr/fr/ark:/43093/mdata3d364fe67e917f60270cd4d39be6583e994b0594)).

- Mise à niveau de l'application web vers CubicWeb 3.38.

- Mise en place d'un nouveau serveur d'images IIIF ([IIPImage 1.3](https://iipimage.sourceforge.io/2025/05/iipsrv-1-3)), en remplacement de Loris.

- Améliorations fonctionnelles :
    - affichage de toutes les collections cooccurrentes dans l'histogramme des pages "Collection historique" ;
    - ajout d'un bouton pour exporter la bibliographie présente sur les pages ;
    - corrections de l'affichage de certaines informations dans les listes de résultats ;
    - correction d'un problème de fusion des langues associées à un manuscrit.

**07/07/2025**

- Ajustements divers dans les données d'Initiale au niveau des textes, des éditions, des manuscrits et parties de manuscrit, et des rôles des contributeurs qui leur sont associés.

- Correction des URL de Manifests IIIF d'Internet Archive dans les données de CRII (Catalogues régionaux des incunables informatisés).

- Import et affichage de la bibliographie sur les pages des lieux et des manuscrits en plusieurs volumes (références bibliographiques importées depuis Wikibase).

- Améliorations fonctionnelles :
    - meilleure prise en charge de la traduction en anglais de l'histogramme des collections cooccurrentes ;
    - meilleur affichage des qualificatifs "pas avant/pas après" (provenant de Wikibase) au niveau des dates.

**03/06/2025**

- :material-new-box: Intégration des manuscrits numérisés de la **Bayerische Staatsbibliothek de Munich** ([www.digitale-sammlungen.de](https://www.digitale-sammlungen.de)) (exemple : [Clm 28222](https://portail.biblissima.fr/fr/ark:/43093/mdatae8c8f935cef81706d36f58f78569742f2b4de12a)).
...
- :material-new-box: Intégration des manuscrits numérisés de **ARCA**, la bibliothèque numérique de l'IRHT-CNRS ([arca.irht.cnrs.fr](https://arca.irht.cnrs.fr)) (exemple : [Reims Ms. 874](https://portail.biblissima.fr/fr/ark:/43093/mdataf5e843a301925975c33e11f27cc9bad7741d522c)).
...
- :material-new-box: Intégration des notices et images d'inscriptions du **Corpus des inscriptions de la France médiévale, 2** (Favreau Robert, Michaud Jean. _I. Poitou-Charentes. 2. Département de Vienne (excepté la ville de Poitiers)_. Paris : CNRS Editions, 1975. 230 p.) disponible sur Persée ([www.persee.fr/doc/cifm_0000-0000_1975_cat_2_1](https://www.persee.fr/doc/cifm_0000-0000_1975_cat_2_1)).
...
- :material-new-box: Intégration des notices et images d'inscriptions du **Corpus des inscriptions de la France médiévale, 1** (Favreau Robert, Michaud Jean. _I. Poitou-Charentes. 1. Ville de Poitiers_. Paris : CNRS Editions, 1974. 200 p.) disponible sur Persée ([www.persee.fr/doc/cifm_0000-0000_1974_cat_1_1](https://www.persee.fr/doc/cifm_0000-0000_1974_cat_1_1)) (exemple : [CIFM I, 60](https://portail.biblissima.fr/fr/ark:/43093/inscdata21addb4bc856a7c8f55d7d078f3b9c92710e6006)).

**11/09/2024**

- :material-new-box: Intégration des notices de manuscrits médiévaux et imprimés anciens numérisés de la **Biblioteca Medicea Laurenziana de Florence** (bibliothèque numérique Teca digitale [tecabml.contentdm.oclc.org](https://tecabml.contentdm.oclc.org)).
...
- :material-new-box: Intégration des données du projet **[Fabliaux](https://projet.biblissima.fr/fr/appels-projets/projets-retenus/fabliaux)** (IHRIM, CIHAM) &ndash; corpus numérique de fabliaux français du Moyen Âge publié dans la Base de Français Médiéval (BFM) &ndash; lauréat en 2022 de l'appel à manifestation d'intérêt Biblissima+.
...
- :material-new-box: Intégration des notices de manuscrits médiévaux et imprimés anciens numérisés de **l'École Nationale Supérieure des Beaux-Arts de Paris** (ENSBA - Bibliothèque numérique Alexandrine [alexandrine-bibnum.beauxartsparis.fr](https://alexandrine-bibnum.beauxartsparis.fr)).

**08/01/2024**

- :material-new-box: Intégration des notices de manuscrits médiévaux et imprimés anciens numérisés de la **bibliothèque municipale d'Albi** (bibliothèque numérique Cécilia du réseau des médiathèques du Grand Albigeois : [cecilia.mediatheques.grand-albigeois.fr](https://cecilia.mediatheques.grand-albigeois.fr)).
...
- :material-new-box: Intégration des notices de manuscrits médiévaux et imprimés anciens numérisés de la **Bibliothèque interuniversitaire de la Sorbonne** (bibliothèque numérique NuBIS : [nubis.univ-paris1.fr](https://nubis.univ-paris1.fr)).
...
- :material-new-box: Intégration des notices de manuscrits médiévaux numérisés de la **bibliothèque universitaire de Gand** ([lib.ugent.be](https://lib.ugent.be))


**09/06/2023**

- :material-new-box: Intégration des notices de manuscrits médiévaux occidentaux numérisés de **Leiden University Libraries** (bibliothèques de l'université de Leyde) ([digitalcollections.universiteitleiden.nl](https://digitalcollections.universiteitleiden.nl))

**24/05/2023**

- :material-new-box: Intégration des notices du **Catalogus Codicum Astrologorum Latinorum. II. Les manuscrits astrologiques latins conservés à la Bibliothèque nationale de France à Paris**, éd. D. Juste, publié dans la série _Documents, études et répertoires de l’Institut de Recherche et d’Histoire des Textes, LXXXIV, 2015_, et disponible sur Persée ([www.persee.fr/doc/dirht_0073-8212_2015_cat_84_1](https://www.persee.fr/doc/dirht_0073-8212_2015_cat_84_1))
...
- :material-new-box: Intégration des notices du **Catalogus Codicum Astrologorum Latinorum. I. Les manuscrits astrologiques latins conservés à la Bayerische Staatsbibliothek de Munich**, éd. D. Juste, publié dans la série _Documents, études et répertoires de l’Institut de Recherche et d’Histoire des Textes, LXXXI, 2011_, et disponible sur Persée ([www.persee.fr/doc/dirht_0073-8212_2011_cat_81_1_977](https://www.persee.fr/doc/dirht_0073-8212_2011_cat_81_1_977)).

**04/01/2023**

- :material-new-box: Intégration d'un premier lot de manuscrits et imprimés numérisés des **Bibliothèques Virtuelles Humanistes (BVH)** (CESR, Tours) ([bvh.univ-tours.fr](http://www.bvh.univ-tours.fr)).

## 2022

**12/12/2022**

- :material-new-box: Intégration des notices de manuscrits numérisés des bibliothèques de Bruges (bibliothèque publique et bibliothèque du Grand Séminaire) issues du projet **Mmmonk** (_Medieval Monastic Manuscripts – Open – Network – Knowledge_) ([mmmonk.be](https://www.mmmonk.be)).

**10/11/2022**

- :material-new-box: Intégration des notices de manuscrits et incunables numérisés de :
...
- :material-new-box: Intégration des notices des chartes, des manuscrits et incunables numérisés de :
...
- :material-new-box: Intégration des notices de manuscrits et imprimés anciens numérisés de :
...
- :material-new-box: Intégration des notices des **manuscrits classiques latins de la Bibliothèque Vaticane** publiées dans la série _Documents, études et répertoires de l'Institut de Recherche et d'Histoire des Textes, XXI_ (Tomes I-II-III) et disponibles sur Persée ([www.persee.fr/collection/dirht](https://www.persee.fr/collection/dirht)).

**10/06/2021**

- :material-new-box: Intégration des données des manuscrits provenant des **Collections historiques de la Bibliothèque Universitaire d'Heidelberg** ([handschriften-digital.uni-hd.de](http://handschriften-digital.uni-hd.de)).

**06/05/2021**

- :material-new-box: Première phase d'intégration des données de la base **JONAS** ([jonas.irht.cnrs.fr](http://jonas.irht.cnrs.fr)), le répertoire des textes et des manuscrits médiévaux d'oc et d'oïl de l’IRHT-CNRS.
...
- :material-new-box: Intégration des données de la base **Comparatio** ([comparatio.irht.cnrs.fr](http://comparatio.irht.cnrs.fr)) sur les chants liturgiques médiévaux (IRHT-CNRS).
...
- :material-new-box: Intégration de **Pinakes**, base des textes et manuscrits grecs de l'IRHT-CNRS ([pinakes.irht.cnrs.fr](http://pinakes.irht.cnrs.fr)).
- :material-new-box: Deuxième phase d'intégration des données du catalogue **BnF Archives et Manuscrits** :
...
- :material-new-box: Intégration de **Mandragore**, base des manuscrits enluminés de la Biblitohèque nationale de France (BnF) ([mandragore.bnf.fr](http://mandragore.bnf.fr)).
- :material-new-box: Intégration des données sur les manuscrits médiévaux de la bibliothèque de **Wellcome Collection** (Wellcome Library) ([wellcomelibrary.org](http://wellcomelibrary.org)).

**08/02/2018**

Enrichissement des données :

- :material-new-box: Première phase d'intégration des données du catalogue **BnF Archives et Manuscrits** ([archivesetmanuscrits.bnf.fr](https://archivesetmanuscrits.bnf.fr)) : traitement des fonds de la **Bibliothèque de l’Arsenal**. L’intégration des données prend comme point de départ les informations sur les anciens possesseurs renseignés dans les instruments de recherche EAD.
...
- :material-new-box: Intégration de la base **_Bibliothèques Françoises_** ([bibfr.bvh.univ-tours.fr](https://bibfr.bvh.univ-tours.fr)) (CESR-BVH, Université de Tours).
...
- :material-new-box: Intégration de deux nouvelles sources de données :
