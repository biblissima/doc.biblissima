La plateforme des référentiels d'autorité de Biblissima ([data.biblissima.fr](https://data.biblissima.fr)) dispose des mêmes accès par API que Wikidata ou les autres instances de Mediawiki/Wikibase :
